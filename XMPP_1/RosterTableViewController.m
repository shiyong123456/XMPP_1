...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = [XMPPManager shareManager].stream.myJID.user;
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    if (buttonIndex) {
        ...
        XMPPJID *jid = [XMPPJID jidWithUser:textField.text domain:KDomin resource:KResouse];
...
-(void)xmppRosterDidEndPopulating:(XMPPRoster *)sender{
    NSLog(@"%s__%d__|结束检索好友",__FUNCTION__,__LINE__);
}
